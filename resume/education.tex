...
\newcommand{\educationMooc}{
  \cventry
  {Coursera, Stanford University, MITx, \EN{DeCifris Association}\IT{Ass.ne DeCifris}, LinkedIn Learning}
  {
    \EN{Workshops, MOOCs, self-taught}
    \IT{Workshops, MOOCs, autodidatta}
  }
  {}
  {2011--\the\year{}}
  {
    \begin{cvitems}
      ...
      \item {%
        Post-Quantum and Cloud Cryptography,
