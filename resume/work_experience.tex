...
\newcommand{\workSPK}{
  \cventry
  {
    \EN{Governance, project management, and fieldwork for data and cybersecurity}
    \IT{Governo, gestione progetti, e operatività su dati e sicurezza informatica}
  }
  {
    \EN{IT Security Officer -- Sparkasse}
  ...
  {2021--\the\year{}} % Date(s)
  {
    \begin{cvitems}
      \item{
        \EN{Wrote security policies, performed ICT risk assessments, implemented regulatory compliance (Circ. 285, GDPR, DORA), reported to management}
        \IT{Scritto policy di sicurezza, svolto valutazioni di rischio ICT, adeguamento normativo (Circ. 285, GDPR, DORA), reportistica verso management}
      }
      \item{
        \EN{Deployed and managed solutions for Endpoint Detection\&Response, Data Loss Prevention, Breach\&Attack Simulation, certificate management}
        \IT{Messo in linea e amministrato soluzioni Endpoint Detection and Response, Data Loss Prevention, Breach \& Attack Simulation, gestione certificati}
      }
      \item{
      ...
      \item{
        \EN{Wrote and implemented policies and procedures for a stronger data governance and data quality organizational framework}
        \IT{Scritto ed implementato policy e procedure per irrobustire il framework aziendale di data governance e data quality}
      }
      \item{
        \EN{Detected and responded to security incidents and frauds, providing assistance to law enforcement}
        \IT{Individuato, analizzato e risposto ad incidenti di sicurezza e frodi alla clientela, fornendo assistenza alle forze dell'ordine}
      }
      \item{
        \EN{Mentored interns and new hires, promoted a culture of personal growth and office communication}
        \IT{Mentore per stagisti e nuovi assunti, promuovendo la formazione personale e la comunicazione tra uffici}
      }
    \end{cvitems}
  }
}
